...
function Resource(resource: ResourceProps) {
  return (
    <div
      className={`hover:scale-105 cursor-pointer  h-28 w-44 transition-all delay-150 ease-in-out flex flex-col items-center justify-center rounded-lg shadow-md text-black ${
